...
interface SortableItemTileProps {
  item: Item;
  onEdit: () => void;
  onDelete: () => void;
...
export function SortableItemTile({
  item,
  onEdit,
  onDelete,
  onToggleComplete,
      ...
      <div className="p-2">
        <div className="flex items-center gap-2">
          ...
          <div
            {...attributes}
            {...listeners}
            className="flex-shrink-0 cursor-grab active:cursor-grabbing p-1 hover:bg-gray-700 rounded"
